            ...
            {!showForm ? (
                <>
                    <div style={{ marginBottom: 24 }}>
                        ...
                        <p style={{ margin: 0, color: '#64748b', fontSize: 13 }}>Record task completions · view overdue alerts</p>
                    </div>
                    ...
                    <div style={{ backgroundColor: '#1e293b', borderRadius: 12, overflow: 'hidden' }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                {logs.length === 0 && (
                                    <tr><td colSpan={8} style={{ ...cell, textAlign: 'center', color: '#475569', padding: 40 }}>No maintenance logs.</td></tr>
                                )}
                                {logs.map(log => (
                                    <tr key={log.id}>
                                        ...
                                        <td style={cell}>
                                            <span style={{ fontSize: 11, color: '#94a3b8' }}>{FREQ_LABEL[log.frequency] || log.frequency}</span>
                                        </td>
                ...
                <div style={{ backgroundColor: '#1e293b', borderRadius: 12, padding: 28, maxWidth: 680 }}>
                    ...
                    {selected?.task_type === 'measurement' && selected?.measurement_labels?.length > 0 && (
                        <div style={{ margin: '0 0 16px', padding: '16px', backgroundColor: '#0f172a', borderRadius: 8, border: '1px solid #1e3a5f' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                                {selected.measurement_labels.map(l => (
                                    <div key={l.key}>
                                        <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 4 }}>{l.label}</label>
                                        <input
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 14, marginBottom: 14 }}>
                        <div>
                            <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Completed By *</label>
