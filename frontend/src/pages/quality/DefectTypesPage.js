            ...
            {!modal ? (
                ...
                <div style={formPage}>
                    <div style={formHeader}>
                        <button onClick={()=>setModal(false)} style={backBtnS}>← Back to Defect Types</button>
                        <h3 style={{ margin:0, fontSize:20, fontWeight:700 }}>{editId?'Edit Defect Type':'Add Defect Type'}</h3>
                    </div>
                    <div style={grid2}>
