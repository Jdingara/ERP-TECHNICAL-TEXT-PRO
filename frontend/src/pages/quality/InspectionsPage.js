            ...
            {modal && (
                <div style={overlay}>
                    <div style={{ ...modalBox, width: 600 }}>
                        <h3 style={{ margin: '0 0 20px', color: '#10b981' }}>New QC Inspection</h3>
                        ...
                        {/* Result guidance */}
                        <div style={{ marginTop: 12, fontSize: 12, color: '#64748b', background: '#f8fafc', borderRadius: 8, padding: '8px 12px' }}>
                            <b>Pass</b> → Batch status: Finished &nbsp;|&nbsp;
                            <b>Fail</b> → Batch status: QC Failed &nbsp;|&nbsp;
                            <b>Rework</b> → Batch status: Rework &nbsp;|&nbsp;
                            <b>Conditional Pass</b> → Batch status: Finished
                        </div>
