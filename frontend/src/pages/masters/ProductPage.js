        ...
        <div style={{ padding:24 }}>
            ...
            <div style={{ overflowX:'auto' }}>
                <table style={tableS}><thead><tr style={{ background:'#1e293b', color:'#fff' }}>
                    ...
                    {rows.length===0 && <tr><td colSpan={8} style={{ textAlign:'center',padding:40,color:'#94a3b8' }}>No products</td></tr>}
                </tbody></table>
            </div>
            {modal && (
                <div style={overlay}><div style={mBox}>
                    <h3 style={{ margin:'0 0 20px' }}>{editId?'Edit Product':'Add Product'}</h3>
                    <div style={grid2}>
                        ...
                        <F label="Composition" style={{ gridColumn:'1/-1' }}><input style={inpS} placeholder="e.g. 60% Polyester 40% Cotton" {...inp('composition')} /></F>
                    </div>
