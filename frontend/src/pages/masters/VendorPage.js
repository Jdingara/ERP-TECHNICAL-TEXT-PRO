                ...
                <>
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24 }}>
                        <div>
                            ...
                            <p style={{ margin:'4px 0 0', color:'#64748b', fontSize:13 }}>Suppliers and job-work vendors</p>
                        </div>
                    ...
                    <div style={{ backgroundColor:'#1e293b', borderRadius:12, overflow:'hidden', overflowX:'auto' }}>
                        <table style={tableS}><thead><tr>
                            ...
                            {rows.length===0 && <tr><td colSpan={9} style={{ textAlign:'center',padding:40,color:'#475569' }}>No vendors found</td></tr>}
                        </tbody></table>
                    </div>
                </>
            ) : (
...
const searchS  = { padding:'8px 14px', borderRadius:8, border:'1px solid #334155', backgroundColor:'#0f172a', color:'#f1f5f9', fontSize:13, width:300, outline:'none' };
