                ...
                <>
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24 }}>
                        <div>
                            ...
                            <p style={{ margin:'4px 0 0', color:'#64748b', fontSize:13 }}>Define measurement units used across the system</p>
                        </div>
                        <button onClick={openAdd} style={btn('#06b6d4')}>+ Add UOM</button>
                    </div>
                    <div style={{ backgroundColor:'#1e293b', borderRadius:12, overflow:'hidden', maxWidth:500 }}>
                        <table style={tableS}><thead><tr>
                            ...
                            {rows.length===0 && <tr><td colSpan={3} style={{ textAlign:'center',padding:40,color:'#475569' }}>No UOMs</td></tr>}
                        </tbody></table>
                    </div>
                </>
            ) : (
