                ...
                <>
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24 }}>
                        <div>
                            ...
                            <p style={{ margin:'4px 0 0', color: pt.colors.dimText, fontSize:13 }}>Production steps and their machine types</p>
                        </div>
                        ...
                        <table style={tableS}><thead><tr>
                            ...
                            {rows.map(r=>(
                                <tr key={r.id}>
                                    ...
                                    <td style={{ ...tdS, color: pt.colors.muted }}>{r.description}</td>
                                    <td style={tdS}>
                            ...
                            {rows.length===0 && <tr><td colSpan={6} style={{ textAlign:'center',padding:40,color: pt.colors.muted }}>No processes</td></tr>}
                        </tbody></table>
                    </div>
                </>
            ) : (
