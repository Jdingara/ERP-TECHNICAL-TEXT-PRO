                ...
                <>
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24 }}>
                        <div>
                            ...
                            <p style={{ margin:'4px 0 0', color: pt.colors.dimText, fontSize:13 }}>Warehouse and shop floor locations</p>
                        </div>
                    ...
                    <div style={{ backgroundColor: pt.colors.card, borderRadius:12, overflow:'hidden' }}>
                        <table style={tableS}><thead><tr>
                            ...
                            {rows.length===0 && <tr><td colSpan={4} style={{ textAlign:'center',padding:40,color: pt.colors.muted }}>No locations</td></tr>}
                        </tbody></table>
                    </div>
                </>
            ) : (
