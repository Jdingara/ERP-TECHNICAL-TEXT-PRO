            ...
            {!modal ? (
                <>
                    <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center', marginBottom:24 }}>
                        <div>
                            ...
                            <p style={{ margin:'4px 0 0', color:'#64748b', fontSize:13 }}>Warehouse and shop floor locations</p>
                        </div>
                    ...
                    <div style={{ backgroundColor:'#1e293b', borderRadius:12, overflow:'hidden' }}>
                        <table style={tableS}><thead><tr>
                            ...
                            {rows.map(r=>(
                                <tr key={r.id}>
                                    <td style={{ ...tdS, fontWeight:600 }}>{r.code}</td>
                            ...
                            {rows.length===0 && <tr><td colSpan={4} style={{ textAlign:'center',padding:40,color:'#475569' }}>No locations</td></tr>}
                        </tbody></table>
                    </div>
                </>
            ) : (
                <div style={formPage}>
                    <div style={formHeader}>
                        <button onClick={()=>setModal(false)} style={backBtnS}>← Back to Locations</button>
                        <h3 style={{ margin:0, fontSize:20, fontWeight:700 }}>{editId?'Edit Location':'Add Location'}</h3>
                    </div>
...
const formPage   = { backgroundColor:'#1e293b', borderRadius:12, padding:28, maxWidth:500 };
