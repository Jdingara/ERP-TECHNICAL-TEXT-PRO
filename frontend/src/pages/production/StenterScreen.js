...
function TempZone({ label, value, onChange }) {
    ...
    return (
        <div>
            <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>{label} (°C)</label>
        ...
        <div style={{ padding: '24px 28px', fontFamily: 'Inter, sans-serif', color: '#f1f5f9', minHeight: '100vh', backgroundColor: '#0b1120' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
                <div>
                    ...
                    <p style={{ margin: '4px 0 0', color: '#64748b', fontSize: 13 }}>Temperature zones · Speed · Width · Overfeed</p>
                </div>
            ...
            {showForm && (
                <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.75)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
                    <div style={{ backgroundColor: '#1e293b', borderRadius: 12, width: '100%', maxWidth: 820, maxHeight: '90vh', overflowY: 'auto', padding: 28 }}>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 14 }}>
                            ...
                            <div>
                                <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Stenter Machine *</label>
                        ...
                        {/* Temperature Panel */}
                        <div style={{ margin: '0 0 14px', padding: '16px', backgroundColor: '#0f172a', borderRadius: 8, border: '1px solid #7c2d12' }}>
                        ...
                        <div style={{ margin: '0 0 14px', padding: '16px', backgroundColor: '#0f172a', borderRadius: 8, border: '1px solid #1e3a5f' }}>
                            ...
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                                ...
                                <div>
                                    <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Width (cm)</label>
                                    <input type="number" value={form.width_cm} onChange={e => setForm(f => ({ ...f, width_cm: e.target.value }))} style={inp} placeholder="e.g. 160" />
                                </div>
                                <div>
                                    <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Overfeed %</label>
                                ...
                                <div style={{ gridColumn: '1/-1' }}>
                                    <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Chemical Recipe</label>
            ...
            <div style={{ backgroundColor: '#1e293b', borderRadius: 12, overflow: 'hidden' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                        {entries.length === 0 && (
                            <tr><td colSpan={12} style={{ ...cell, textAlign: 'center', color: '#475569', padding: 40 }}>No stenter entries yet.</td></tr>
                        )}
                        {entries.map(e => (
                            <tr key={e.id}>
