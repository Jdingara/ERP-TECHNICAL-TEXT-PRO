...
//          Loom-wise daily output, beam allocation, RPM, picks/cm
// ============================================================
        ...
        <div style={{ padding: '24px 28px', fontFamily: 'Inter, sans-serif', color: '#f1f5f9', minHeight: '100vh', backgroundColor: '#0b1120' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
                <div>
                    ...
                    <p style={{ margin: '4px 0 0', color: '#64748b', fontSize: 13 }}>Loom-wise output · Beam allocation · RPM · Picks/cm</p>
                </div>
                ...
                <div style={{ position: 'fixed', inset: 0, backgroundColor: 'rgba(0,0,0,0.7)', zIndex: 1000, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
                    <div style={{ backgroundColor: '#1e293b', borderRadius: 12, width: '100%', maxWidth: 780, maxHeight: '90vh', overflowY: 'auto', padding: 28 }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 20 }}>
                            <h3 style={{ margin: 0, fontSize: 18 }}>New Weaving Entry</h3>
                        ...
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                            ...
                            <div>
                                <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Loom Machine *</label>
                            ...
                            <div>
                                <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Beam (from Warping)</label>
                        ...
                        {/* Weaving Params */}
                        <div style={{ margin: '20px 0 10px', padding: '14px 16px', backgroundColor: '#0f172a', borderRadius: 8, border: '1px solid #14532d' }}>
                            <p style={{ margin: '0 0 12px', color: '#10b981', fontWeight: 600, fontSize: 13 }}>Weaving Parameters</p>
                            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                                <div>
                                    <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Loom RPM</label>
                                    <input type="number" value={form.loom_rpm} onChange={e => setForm(f => ({ ...f, loom_rpm: e.target.value }))} style={inp} placeholder="e.g. 350" />
                                </div>
                                <div>
                                    <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Picks / cm</label>
                                ...
                                <div>
                                    <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Weft Pattern</label>
                                ...
                                <div>
                                    <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Fabric Width (cm)</label>
                                ...
                                <div>
                                    <label style={{ fontSize: 12, color: '#94a3b8', display: 'block', marginBottom: 5 }}>Efficiency %</label>
            ...
            <div style={{ backgroundColor: '#1e293b', borderRadius: 12, overflow: 'hidden' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                    ...
                    <tbody>
                        {entries.length === 0 && (
                            <tr><td colSpan={11} style={{ ...cell, textAlign: 'center', color: '#475569', padding: 40 }}>No weaving entries yet.</td></tr>
                        )}
                        {entries.map(e => (
                            <tr key={e.id}>
