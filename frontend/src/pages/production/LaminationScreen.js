            ...
            {!showForm ? (
                <>
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
                        <div>
                            ...
                            <p style={{ margin: '4px 0 0', color: pt.colors.dimText, fontSize: 13 }}>Film type · GSM · Coat weight · Curing temperature</p>
                        </div>
                    ...
                    <div style={{ backgroundColor: pt.colors.card, borderRadius: 12, overflow: 'hidden' }}>
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                {entries.length === 0 && (
                                    <tr><td colSpan={12} style={{ ...cell, textAlign: 'center', color: pt.colors.muted, padding: 40 }}>No lamination entries yet.</td></tr>
                                )}
                                {entries.map(e => (
                                    <tr key={e.id}>
                ...
                <div style={{ backgroundColor: pt.colors.card, borderRadius: 12, padding: 28, maxWidth: 860 }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24, paddingBottom: 16, borderBottom: `1px solid ${pt.colors.border}` }}>
                        ...
                        <h3 style={{ margin: 0, fontSize: 18, fontWeight: 700 }}>New Lamination Entry</h3>
                    </div>
                    ...
                    <div style={{ margin: '0 0 14px', padding: '16px', backgroundColor: pt.colors.inner, borderRadius: 8, border: '1px solid #831843' }}>
                        <p style={{ margin: '0 0 14px', color: '#ec4899', fontWeight: 700, fontSize: 13 }}>Lamination Parameters</p>
                        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: 12 }}>
                            <div>
                                <label style={{ fontSize: 12, color: pt.colors.muted, display: 'block', marginBottom: 5 }}>Film Type</label>
                            ...
                            <div>
                                <label style={{ fontSize: 12, color: pt.colors.muted, display: 'block', marginBottom: 5 }}>Film GSM</label>
                            ...
                            <div>
                                <label style={{ fontSize: 12, color: pt.colors.muted, display: 'block', marginBottom: 5 }}>Coat Weight (GSM)</label>
                            ...
                            <div>
                                <label style={{ fontSize: 12, color: pt.colors.muted, display: 'block', marginBottom: 5 }}>Adhesive Type</label>
                            ...
                            <div>
                                <label style={{ fontSize: 12, color: pt.colors.muted, display: 'block', marginBottom: 5 }}>Line Speed (m/min)</label>
                            ...
                            <div>
                                <label style={{ fontSize: 12, color: pt.colors.muted, display: 'block', marginBottom: 5 }}>Curing Temp (°C)</label>
